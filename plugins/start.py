...
bot_username = os.environ.get("BOT_USERNAME","torplus_bot")
log_channel = int(os.environ.get("LOG_CHANNEL", "-1001738737106"))
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/joinai_lab")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/AmolAdhude")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/joinDSWORLD'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/theonemoviee')],
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact Developer 🦋", url='https://telegram.me/amoltheone')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://youtube.com/AmolAdhude')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/joinDSWORLD'),
                                                                     InlineKeyboardButton("  Support Group 🦋", url='https://t.me/joinDSWORLD')],
